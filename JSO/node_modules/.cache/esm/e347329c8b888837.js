let Observable,map;_8b8‍.w("rxjs",[["Observable",["Observable"],function(v){Observable=v}]]);_8b8‍.w("rxjs/operators",[["map",["map"],function(v){map=v}]]);
...
const monze$ = Observable.create((subject) => {
 ...
 const primaryX = monze$.subscribe(_8b8‍.g.console.log);
 ...
 ).subscribe(val => _8b8‍.g.console.log(val));
