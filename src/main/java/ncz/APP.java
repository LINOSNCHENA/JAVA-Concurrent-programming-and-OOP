...
public class APP {
  ...
  //   int A[] = {1, 3, 6, 4, 1, 2 }; // Sorting 5
   //  int A[]={4, 5, 6, 2}; // BACK TO ONE1
    ...
    System.out.print(Y1);
    System.out.println("\n ================== FINAL-SECOND-PRODUCED =================" + "\n");
    MissingInteger job = new MissingInteger();
    int Y = job.solution(A);
    System.out.print(Y);
    System.out.println("\n ================== FINAL-THIRD-PRODUCED =================" + "\n");
    MissingInterger1 jobx = new MissingInterger1();
    int Yx= jobx.solution(A);
    System.out.print(Yx);
  }
}